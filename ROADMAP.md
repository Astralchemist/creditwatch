...
## 1.0.0 — dependable Vast monitoring on macOS

Scope: one Vast.ai account, on macOS. Several providers at once is 1.1.0, and the settings pane
already says so on screen. Windows and Linux are 1.1.0 too — their credential stores are written
...
## 1.1.0 — telemetry, efficiency and more platforms
...
- [ ] Windows and Linux as supported platforms, deferred out of 1.0.0 rather than dropped
...
- [ ] Reach a phone while the computer sleeps. Publishing from the desktop shipped in 1.0.0 and
